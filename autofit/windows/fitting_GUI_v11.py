...
str(freq_low),str(inten_high),str(inten_low),str(temperature),str(Jmax),str(self.num_of_triples),check_peaks_str,str(trans_1),str(trans_2),str(trans_3))
	...
	autofit_NS_success_flag = autofit_NS_module.autofit_NS(job_name,u_A,u_B,u_C,A,B,C,DJ,DJK,DK,dJ,dK,freq_high,freq_low,inten_high,inten_low,int(processors),temperature,Jmax,trans_1,trans_2,trans_3,check_peaks_list,self.peaklist,trans_1_peaks,trans_2_peaks,trans_3_peaks)
...
#            self.c_box.setText(C)
    ...
    def run_fit_button_push(self):
        ...
        input_file += "             200  %s 1.0E+00 \n" % DJ
        input_file += "            1100  %s 1.0E+00 \n" % DJK
        input_file += "            2000  %s 1.0E+00 \n" % DK
        input_file += "           40100  %s 1.0E+00 \n" % dJ
        input_file += "           41000  %s 1.0E+00 \n" % dK
