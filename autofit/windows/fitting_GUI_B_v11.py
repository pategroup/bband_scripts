...
def on_key( event ):
    ...
    if event.key=="q" or event.key=="Q":
        ...
        x = plt.ginput(1)
        if refine_flag==1:
            check.circles[0].set_facecolor(facecolor_on)
            check.circles[1].set_facecolor(facecolor_off)
            check.circles[2].set_facecolor(facecolor_off)
            check.circles[3].set_facecolor(facecolor_off)
            check2.circles[0].set_facecolor(facecolor_on)
            check2.circles[1].set_facecolor(facecolor_off)
            check2.circles[2].set_facecolor(facecolor_off)
            check2.circles[3].set_facecolor(facecolor_off)
...
def refine_main(A,B,C,dA,dB,dC,DJ,DJK,DK,dJ,dK,ua,ub,uc,dua,dub,duc,f_lower,f_upper,T,J_max,last_times_picked_list):
    ...
    global facecolor_on,facecolor_off
    facecolor_on = check.circles[0].get_facecolor()
    facecolor_off = check.circles[1].get_facecolor()
