...
class AppForm(QMainWindow):
    ...
    def replot_button(self):
        ...
        if self.counter != 0:
            picked_list = fitting_GUI_B_v4.picked_list
        
        else:
            picked_list = []
        self.counter+=1
        try:
            fitting_GUI_B_v4.run_main(A,B,C,dA,dB,dC,DJ,DJK,DK,ua,ub,uc,T,picked_list,int(unicode(self.skip_box.text())),self.filename)
        except AttributeError:
            fitting_GUI_B_v4.run_main(A,B,C,dA,dB,dC,DJ,DJK,DK,ua,ub,uc,T,picked_list,int(unicode(self.skip_box.text())))
    ...
    def peaks_button_push(self):
        print fitting_GUI_B_v4.picked_list
	...
	hbox.addWidget(self.ua_box,7,2)
        ...
        hbox.addWidget(self.T_box,10,2)	
